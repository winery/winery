...
import { TopologyFragmentRefinementModelRouterModule } from './topologyFragmentRefinementModelRouter.module';
...
@NgModule({
    imports: [
        ...
        TopologyFragmentRefinementModelRouterModule,
    ]
})
export class TopologyFragmentRefinementModelModule {
}
