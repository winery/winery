...
public class Constants {
    ...
    public static final String TAG_NAME_PROVIDER = "provider";

    public static final String SERVICE_TEMPLATE_GROUP = "ServiceTemplate";
    public static final String ARTIFACT_TEMPLATE_GROUP = "ArtifactTemplate";

    public static final String DATA_TRANSFER_TYPE_PULL = "pull";
}
