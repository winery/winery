...
public class YumAnalyzer implements CommandAnalyzer {
    public List<Component> analyze(String command) {
        if (!(command.contains(" install ") || command.contains(" localinstall ") || command.contains(" groupinstall ") || command.contains(" reinstall "))) {
            return new ArrayList<>();
        }
        command = command.replace(Commands.Yum.asString(), "");
        ...
        for (String word : words) {
            ...
            if (word.equals("install") || word.equals("localinstall") || word.equals("groupinstall") || word.equals("langinstall")) {
                packages.clear();
            }
        }
