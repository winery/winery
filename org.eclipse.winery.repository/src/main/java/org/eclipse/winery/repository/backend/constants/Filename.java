...
public class Filename {
    ...
    public static final String FILENAME_JSON_MUTLI_REPOSITORIES = "repositories.json";
    public static final String FILENAME_JSON_TENANT_REPOSITORIES = "tenants.json";
