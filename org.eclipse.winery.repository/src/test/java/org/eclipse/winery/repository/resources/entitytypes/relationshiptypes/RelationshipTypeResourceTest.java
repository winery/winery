...
public class RelationshipTypeResourceTest extends AbstractResourceTest {
	...
	public void kiwiVisualAppearance() throws Exception {
		this.assertGet("relationshiptypes/http%253A%252F%252Fwinery.opentosca.org%252Ftest%252Frelationshiptypes%252Ffruits/kiwi/visualappearance/", "entitytypes/relationshiptypes/kiwi_initial.json");
	}
