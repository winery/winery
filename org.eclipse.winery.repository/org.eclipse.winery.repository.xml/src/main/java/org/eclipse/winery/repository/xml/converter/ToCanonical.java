...
public class ToCanonical {
     ...
     */
    public TDefinitions convert(org.eclipse.winery.model.tosca.xml.TDefinitions canonical, boolean convertImports) {
        ...
        TDefinitions.Builder builder = new TDefinitions.Builder(canonical.getId(), canonical.getTargetNamespace())
    ...
    private TRelationshipType convert(org.eclipse.winery.model.tosca.xml.TRelationshipType canonical) {
    ...
    private List<TInterface> convertInterfaces(org.eclipse.winery.model.tosca.xml.@Nullable TInterfaces interfaces) {
        if (interfaces == null) {
    ...
    private TInterface convertInterface(org.eclipse.winery.model.tosca.xml.TInterface canonical) {
        return new TInterface.Builder(canonical.getName(), convertOperations(canonical.getOperation())).build();
    }

    private List<TOperation> convertOperations(List<org.eclipse.winery.model.tosca.xml.TOperation> operation) {
        return operation.stream().map(this::convert).collect(Collectors.toList());
    }

    private TOperation convert(org.eclipse.winery.model.tosca.xml.TOperation canonical) {
    ...
    private TParameter convert(org.eclipse.winery.model.tosca.xml.TParameter canonical) {
        return new TParameter.Builder(canonical.getName(), canonical.getType(), TBoolean.fromValue(canonical.getRequired().value())).build();
    }

    private TRelationshipTypeImplementation convert(org.eclipse.winery.model.tosca.xml.TRelationshipTypeImplementation canonical) {
    ...
    private TImplementationArtifacts.ImplementationArtifact convert(org.eclipse.winery.model.tosca.xml.TImplementationArtifacts.ImplementationArtifact canonical) {
    ...
    private TTag convert(org.eclipse.winery.model.tosca.xml.TTag canonical) {
        return new TTag.Builder().setName(canonical.getName()).setValue(canonical.getValue()).build();
    }

    private TRequiredContainerFeature convert(org.eclipse.winery.model.tosca.xml.TRequiredContainerFeature canonical) {
        TRequiredContainerFeature result = new TRequiredContainerFeature();
        result.setFeature(canonical.getFeature());
        return result;
    }

    private TPolicyType convert(org.eclipse.winery.model.tosca.xml.TPolicyType canonical) {
    ...
    private TRequirementType convert(org.eclipse.winery.model.tosca.xml.TRequirementType canonical) {
    ...
    private TNodeTypeImplementation convert(org.eclipse.winery.model.tosca.xml.TNodeTypeImplementation canonical) {
    ...
    private TDeploymentArtifact convert(org.eclipse.winery.model.tosca.xml.TDeploymentArtifact canonical) {
    ...
    private TNodeType convert(org.eclipse.winery.model.tosca.xml.TNodeType canonical) {
    ...
    private TInterfaceDefinition convert(org.eclipse.winery.model.tosca.xml.TInterfaceDefinition canonical) {
...
//        definition.setInputs(canonical.getInputs().stream().map(this::convert).collect(Collectors.toList()));
    ...
    private TOperationDefinition convert(org.eclipse.winery.model.tosca.xml.TOperationDefinition canonical) {
    ...
    private TImplementation convert(org.eclipse.winery.model.tosca.xml.TImplementation canonical) {
    ...
    private TArtifact convert(org.eclipse.winery.model.tosca.xml.TArtifact canonical) {
    ...
    private TRequirementDefinition convert(org.eclipse.winery.model.tosca.xml.TRequirementDefinition canonical) {
    ...
    private TCapabilityDefinition convert(org.eclipse.winery.model.tosca.xml.TCapabilityDefinition canonical) {
    ...
    private TConstraint convert(org.eclipse.winery.model.tosca.xml.TConstraint canonical) {
    ...
    private TCapability convert(org.eclipse.winery.model.tosca.xml.TCapability canonical) {
    ...
    private TEntityTemplate.Properties convertProperties(org.eclipse.winery.model.tosca.xml.TEntityTemplate.Properties canonical) {
        ...
        if (canonical.getAny() != null) {
            ...
            props.setKVProperties((Map)canonical.getKVProperties());
        }
        return props;
    }

    private TPropertyConstraint convert(org.eclipse.winery.model.tosca.xml.TPropertyConstraint canonical) {
    ...
    private TInterfaceType convert(org.eclipse.winery.model.tosca.xml.TInterfaceType canonical) {
    ...
    private TExtension convert(org.eclipse.winery.model.tosca.xml.TExtension canonical) {
    ...
    private TDocumentation convert(org.eclipse.winery.model.tosca.xml.TDocumentation canonical) {
    ...
    private TCapabilityType convert(org.eclipse.winery.model.tosca.xml.TCapabilityType canonical) {
    ...
    private TArtifactType convert(org.eclipse.winery.model.tosca.xml.TArtifactType canonical) {
    ...
    private TArtifactTemplate convert(org.eclipse.winery.model.tosca.xml.TArtifactTemplate canonical) {
    ...
    private TArtifactReference convert(org.eclipse.winery.model.tosca.xml.TArtifactReference canonical) {
...
//        xml.getIncludeOrExclude().add(canonical.getIncludeOrExclude());
    ...
    private TImport convert(org.eclipse.winery.model.tosca.xml.TImport canonical) {
    ...
    private TServiceTemplate convert(org.eclipse.winery.model.tosca.xml.TServiceTemplate canonical) {
    ...
    private TPlan convert(org.eclipse.winery.model.tosca.xml.TPlan canonical) {
    ...
    private TCondition convert(org.eclipse.winery.model.tosca.xml.TCondition canonical) {
    ...
    private TBoundaryDefinitions convert(org.eclipse.winery.model.tosca.xml.TBoundaryDefinitions canonical) {
    ...
    private TExportedInterface convert(org.eclipse.winery.model.tosca.xml.TExportedInterface canonical) {
    ...
    private TExportedOperation convert(org.eclipse.winery.model.tosca.xml.TExportedOperation canonical) {
    ...
    private TExportedOperation.RelationshipOperation convert(org.eclipse.winery.model.tosca.xml.TExportedOperation.RelationshipOperation canonical) {
    ...
    private TExportedOperation.NodeOperation convert(org.eclipse.winery.model.tosca.xml.TExportedOperation.NodeOperation canonical) {
    ...
    private TPolicy convert(org.eclipse.winery.model.tosca.xml.TPolicy canonical) {
    ...
    private TCapabilityRef convert(org.eclipse.winery.model.tosca.xml.TCapabilityRef canonical) {
    ...
    private TRequirementRef convert(org.eclipse.winery.model.tosca.xml.TRequirementRef canonical) {
    ...
    private TRequirement convert(org.eclipse.winery.model.tosca.xml.TRequirement canonical) {
    ...
    private TPropertyMapping convert(org.eclipse.winery.model.tosca.xml.TPropertyMapping canonical) {
    ...
    private TTopologyTemplate convert(org.eclipse.winery.model.tosca.xml.TTopologyTemplate canonical) {
    ...
    private TNodeTemplate convert(org.eclipse.winery.model.tosca.xml.TNodeTemplate canonical) {
    ...
    private TRelationshipTemplate convert(org.eclipse.winery.model.tosca.xml.TRelationshipTemplate canonical) {
    ...
    private TRelationshipTemplate.RelationshipConstraints.RelationshipConstraint convert(org.eclipse.winery.model.tosca.xml.TRelationshipTemplate.RelationshipConstraints.RelationshipConstraint canonical) {
    ...
    private TRelationshipTemplate.SourceOrTargetElement convert(org.eclipse.winery.model.tosca.xml.TRelationshipTemplate.SourceOrTargetElement canonical) {
        TRelationshipTemplate.SourceOrTargetElement xml = new TRelationshipTemplate.SourceOrTargetElement();
        xml.setRef(convert(canonical.getRef()));
        return xml;
    }

    private RelationshipSourceOrTarget convert(org.eclipse.winery.model.tosca.xml.RelationshipSourceOrTarget canonical) {
        // Capability or NodeTemplate or Requirement
        if (canonical instanceof org.eclipse.winery.model.tosca.xml.TCapability) {
            return convert((org.eclipse.winery.model.tosca.xml.TCapability) canonical);
        }
        if (canonical instanceof org.eclipse.winery.model.tosca.xml.TNodeTemplate) {
            return convert((org.eclipse.winery.model.tosca.xml.TNodeTemplate) canonical);
        }
        if (canonical instanceof org.eclipse.winery.model.tosca.xml.TRequirement) {
            return convert((org.eclipse.winery.model.tosca.xml.TRequirement) canonical);
        }
    ...
    private List<TServiceTemplate> convertServiceTemplates(List<org.eclipse.winery.model.tosca.xml.TServiceTemplate> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TRelationshipType> convertRelationshipTypes(List<org.eclipse.winery.model.tosca.xml.TRelationshipType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TRelationshipTypeImplementation> convertRelationshipImplementations(List<org.eclipse.winery.model.tosca.xml.TRelationshipTypeImplementation> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TPolicyType> convertPolicyTypes(List<org.eclipse.winery.model.tosca.xml.TPolicyType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TRequirementType> convertRequirementTypes(List<org.eclipse.winery.model.tosca.xml.TRequirementType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TNodeTypeImplementation> convertNodeTypeImplementations(List<org.eclipse.winery.model.tosca.xml.TNodeTypeImplementation> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TNodeType> convertNodeTypes(List<org.eclipse.winery.model.tosca.xml.TNodeType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TInterfaceType> convertInterfaceTypes(List<org.eclipse.winery.model.tosca.xml.TInterfaceType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TCapabilityType> convertCapabilityTypes(List<org.eclipse.winery.model.tosca.xml.TCapabilityType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TArtifactType> convertArtifactTypes(List<org.eclipse.winery.model.tosca.xml.TArtifactType> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TArtifactTemplate> convertArtifactTemplates(List<org.eclipse.winery.model.tosca.xml.TArtifactTemplate> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private List<TImport> convertImports(List<org.eclipse.winery.model.tosca.xml.TImport> canonical) {
        return canonical.stream().map(this::convert).collect(Collectors.toList());
    }

    private TDefinitions.Types convertTypes(org.eclipse.winery.model.tosca.xml.TDefinitions.@Nullable Types canonical) {
        if (canonical == null) {
