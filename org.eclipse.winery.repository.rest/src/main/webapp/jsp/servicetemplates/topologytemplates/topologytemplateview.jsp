...
<t:topologyTemplateRenderer topology="${it.topologyTemplate}"
                            repositoryURL="<%=Environment.getUrlConfiguration().getRepositoryApiUrl()%>"
                            client="${it.client}" fullscreen="true" additonalCSS="${it.additonalCSS}"
