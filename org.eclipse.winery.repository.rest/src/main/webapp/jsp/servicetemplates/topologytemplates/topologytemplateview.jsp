 ...
 *
 * Contributors:
 *    Oliver Kopp - initial API, implementation, and update to 2017 repository API
 *******************************************************************************/
--%>
...
<%@page import="org.eclipse.winery.repository.configuration.Environment" %>
...
<t:topologyTemplateRenderer topology="${it.topologyTemplate}" repositoryURL="<%=Environment.getUrlConfiguration().getRepositoryApiUrl()%>" client="${it.client}" fullscreen="true" additonalCSS="${it.additonalCSS}" autoLayoutOnLoad="${it.autoLayoutOnLoad}"/>
