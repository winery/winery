...
public class ParameterResource {
    ...
    public ParameterDefinitions getInputParameters() {
    ...
    public Response putInputParameters(ParameterDefinitions parameters) {
    ...
    @Path("outputs")
    @Produces(MediaType.APPLICATION_JSON)
    public ParameterDefinitions getOutputParameters() {
    ...
    @Path("outputs")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response putOutputParameters(ParameterDefinitions parameters) {
