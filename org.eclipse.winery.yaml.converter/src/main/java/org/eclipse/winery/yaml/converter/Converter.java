...
public class Converter {
    ...
    /**
     * Convert YAML to XML taking a YAML-CSAR as input. The converted files are stored in the repository (which was given at the constructor)
     *
    ...
    public String convertDefinitionsChildToYaml(DefinitionsChildId id) throws MultiException {
        Path path = Utils.getTmpDir(Paths.get(id.getXmlId().getDecoded()));
        convertX2Y(repository.getDefinitions(id), path);
