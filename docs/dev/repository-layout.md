...
- [Directory `imports`](#directory-imports)
  * [Directory layout](#directory-layout-of-the-imports-directory)
...
[ADR-0001](../adr/0001-use-filesystem-as-backend.md)
[ADR-0002](../adr/0002-filesystem-folder-structure-using-type-namespace-id-structure.md).
...
![](figures/FilesystemDirectoryLayout.png)

## Encoding

Encoding of directory and file names is done following [RFC 3986](https://tools.ietf.org/html/rfc3986#section-2.1).
This makes the structure consistent to the URL structure (cf. [REST API](rest.md#url-structure)).
