...
%>
<p><%=completionInterface.getErrorMessage()%>
</p>
<%
...
<tc:relationshipTemplateSelector choices='<%=relationshipTemplateSelection%>'
                                 templateURL='<%=request.getParameter("templateURL")%>'
                                 topologyName='<%=request.getParameter("topologyName")%>'
                                 topologyNamespace='<%=request.getParameter("topologyNamespace")%>'
                                 repositoryURL='<%=request.getParameter("repositoryURL")%>'
...
<tc:topologyTemplateSelector solutionTopologies='<%=topologyTemplateSelection%>'
                             templateURL='<%=request.getParameter("templateURL")%>'
                             topologyName='<%=request.getParameter("topologyName")%>'
                             topologyNamespace='<%=request.getParameter("topologyNamespace")%>'
                             repositoryURL='<%=request.getParameter("repositoryURL")%>'/>
...
<tc:nodeTemplateSelector choices='<%=nodeTemplateSelection%>' templateURL='<%=request.getParameter("templateURL")%>'
                         topologyName='<%=request.getParameter("topologyName")%>'
                         topologyNamespace='<%=request.getParameter("topologyNamespace")%>'
                         repositoryURL='<%=request.getParameter("repositoryURL")%>'
                         stName='<%=request.getParameter("stName")%>'/>
