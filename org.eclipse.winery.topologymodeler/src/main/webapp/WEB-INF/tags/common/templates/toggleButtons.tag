...
<div class="btn-group" data-toggle="buttons-checkbox" id="toggleButtons">
    ...
    <button class="btn active" id="toggleTypeVisibility" onclick="showTypes(!$(this).hasClass('active'));">Types
    </button>
    <button class="btn btn-default" id="togglePropertiesVisibility"
            onclick="showOrHideProperties(!$(this).hasClass('active'));">Properties
    </button>
    <button class="btn btn-default" id="toggleDeploymentArtifactsVisibility"
            onclick="showOrHideDeploymentArtifacts(!$(this).hasClass('active'));">Deployment Artifacts
    </button>
    <button class="btn btn-default" id="toggleReqCapsVisibility"
            onclick="showOrHideReqCaps(!$(this).hasClass('active'));">Requirements &amp; Capabilities
    </button>
    <button class="btn btn-default" id="PoliciesVisibility" onclick="showOrHidePolicies(!$(this).hasClass('active'));">
        Policies
    </button>
    <button class="btn btn-default" id="TargetLocationsVisibility"
            onclick="showOrHideTargetLocations(!$(this).hasClass('active'));">Target Locations
    </button>
</div>
