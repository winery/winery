...
<%@tag language="java" pageEncoding="UTF-8"
       description="This tag is used to render Relationship Templates for selection in a dialog." %>
...
<div id="relationshipTemplateSelector">
    <p> There are several possible Relationship Templates for a connection. <br> Please select your desired
        connection(s): </p>
    <script>
        ...
        <div id="proposaldrawingarea">
            <div id="allRelationships">
                ...
                <nt:nodeTemplateRenderer client="<%=client%>"
                                         ...
                                         repositoryURL='<%=repositoryURL%>' nodeTemplate="<%=nodeTemplate%>"
    ...
    <%}%>
    <button type="button" class="btn btn-primary btn-default" id="btnUseSelection"
            onclick="useRelationshipTemplateSelection()">Use Selection
    </button>
    <script>
