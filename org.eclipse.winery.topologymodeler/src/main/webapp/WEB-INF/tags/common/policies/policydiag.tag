...
<%@attribute name="allPolicyTypes" required="true" type="java.util.Collection"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="updatePolicy" class="btn btn-primary" onclick="addOrUpdatePolicy(false);">
                    Update
                </button>
                <button type="button" id="addPolicy" class="btn btn-primary" onclick="addOrUpdatePolicy(true);">Add
                </button>
            </div>
        </div>
    </div>
...
//			data.unshift(none);
    ...
    function addOrUpdatePolicy(doAdd) {
        ...
        require(["winery-support-common", "tmpl"], function (wsc, tmpl) {
            ...
            if (res) {
                var policyTemplate = {
                    id: $("#policyTemplate :selected").val(),
                    text: $("#policyTemplate :selected").text()
                };
                var renderData = {
                    name: $("#policyName").val(),
