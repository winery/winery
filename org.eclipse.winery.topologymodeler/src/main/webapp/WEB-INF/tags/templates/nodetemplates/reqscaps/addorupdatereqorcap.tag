<%--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~--%>
<%@tag description="Dialog to change a req or cap. Offers function showEditDiagFor${shortName}(id)"
       pageEncoding="UTF-8" %>
...
<%@attribute name="clazz" required="true" type="java.lang.Class"
             description="TRequirement.class or TCapability.class" %>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:660px;">
                ...
                <form id="add${shortName}Form" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <select id="${shortName}NameChooser" class="form-control" type="text"
                                    required="required"> </select>
                        </div>

                        <div class="form-group">
                            <label for="${shortName}TypeDisplay" class="control-label">${shortName} Type:</label>
                            <input id="${shortName}TypeDisplay" class="form-control" type="text" required="required"
                                   disabled="disabled"/>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="add${shortName}btn" class="btn btn-primary"
                        onclick="addOrUpdate${shortName}(false);">Add
                </button>
                <button type="button" id="delete${shortName}btn" class="btn btn-danger"
                        onclick="deleteCurrent${shortName}();">Delete
                </button>
                <button type="button" id="update${shortName}btn" class="btn btn-primary"
                        onclick="addOrUpdate${shortName}(true);">Change
                </button>
            </div>
        </div>
    </div>
        ...
        require(["winery-support-common"], function (wsc) {
            ...
            $.ajax({
                ...
                if (update) {
                    ...
                    var data = {
                        id: $("#${shortName}NameChooser :selected").val(),
                        text: $("#${shortName}NameChooser :selected").text()
                    };
                    if (data == null) {
