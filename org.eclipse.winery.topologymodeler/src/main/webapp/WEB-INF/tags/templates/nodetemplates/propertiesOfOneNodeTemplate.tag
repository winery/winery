...
<div id="NTPropertiesView" class="propertiesView" style="display: none;">
    ...
    <div id="nodeTemplateInformationSection">
        ...
        <fieldset>
            ...
            <ct:spinnerwithinphty min="0" width="10" changedfunction="minInstancesChanged" label="min"
                                  id="minInstances"/>
            <ct:spinnerwithinphty min="1" width="10" changedfunction="maxInstancesChanged" label="max" id="maxInstances"
                                  withinphty="true"/>
        </fieldset>
    </div>
